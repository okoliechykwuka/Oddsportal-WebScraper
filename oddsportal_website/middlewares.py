...
# scrapy shell -s USER_AGENT= 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.81 Safari/537.36 Edg/104.0.1293.54' 'https://www.oddsportal.com/soccer/world/viareggio-cup-2017/results/'
...
class OddsportalWebsiteSpiderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
    # scrapy acts as if the spider middleware does not modify the
    # passed objects.
...
class OddsportalWebsiteDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
